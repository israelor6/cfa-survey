...
const answerKeys: Record<number, Exclude<keyof Answers, 'q4_relationship_drivers' | 'implementation_blocker' | 'implementation_blocker_other'>> = {
  1: 'q1_deposit_threshold', 2: 'q2_liquidity_value', 3: 'q3_relationship_pricing',
...
export function App() {
  ...
  const selected = step && step !== 4 ? session.answers[answerKeys[step]] : undefined;
