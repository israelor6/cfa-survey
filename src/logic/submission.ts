...
export function buildPayload(session: SessionState) {
  ...
  const structured: SurveySubmission = {
    ...
    answers: {
      q1_primary_customer_share: session.answers.q1_primary_customer_share ?? '',
      q1_primary_customers_over_10k: session.answers.q1_primary_customers_over_10k ?? '',
      q2_deposit_viability: session.answers.q2_deposit_viability ?? '',
  ...
  return {
    ...
    q1_primary_customer_share: structured.answers.q1_primary_customer_share,
    q1_primary_customers_over_10k: structured.answers.q1_primary_customers_over_10k,
    q2_deposit_viability: structured.answers.q2_deposit_viability,
